...
class Bugger
    ...
    def prompt()
        ...
        if(task_id == nil)
            ...
            time_spent = @db.time_spent_by(task_id)
            task_name = @db.get_task_name(task_id)
        end
